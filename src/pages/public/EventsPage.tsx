    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
                {/* Header */}
                {event.bannerUrl && (
                    <img src={event.bannerUrl} alt={event.title} className="w-full h-48 object-contain" />
                )}
            ...
            {isLoading ? (
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {events.map((event, i) => (
                        ...
                        >
                            {event.bannerUrl ? (
                                <img src={event.bannerUrl} alt={event.title} className="w-full max-h-72 object-contain hover:scale-105 transition-transform duration-300" />
                            ) : (
